    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (menu) {
                ...
                case 6:
                    Category searchCategory = view.inputCategory();
                    controller.showProductsByCategory(searchCategory);
                    break;

                case 7:
                    int stockLimit = view.inputStockLimit();
                    controller.showLowStockProducts(stockLimit);
                    break;
